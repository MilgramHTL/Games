...
public class Soundsystem extends Main{
        ...
        private org.newdawn.slick.Music musica;
        /** second music that can be played */
        private org.newdawn.slick.Music musicb;
        /** The sound to be played */
        ...
        public void init(GameContainer container) throws SlickException {
            ...
            music = musica = new org.newdawn.slick.Music("testdata/SMB-X.XM");
            //music = musica = new Music("testdata/theme.ogg", true);
            musicb = new org.newdawn.slick.Music("testdata/Shine.ogg", true);
    ...
    /**
        ...
        public static void main(String[] argv) {
            try {
                AppGameContainer container = new AppGameContainer(new org.newdawn.slick.tests.SoundTest());
